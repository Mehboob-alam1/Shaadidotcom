...
//        this.aboutMe=userProfile.getAboutMe();
        this.profileFor=userProfile.getProfileFor();
        this.gender=userProfile.getGender();
        this.fullName=userProfile.getFullName();
        this.dob=userProfile.getDob();
        this.religion=userProfile.getReligion();
        this.community=userProfile.getCommunity();
        this.livingIn=userProfile.getLivingIn();
        this.email=userProfile.getEmail();
        this.phoneNumber=userProfile.getPhoneNumber();
        this.countryCode=userProfile.getCountryCode();
        this.stateName=userProfile.getStateName();
        this.stateCode=userProfile.getStateCode();
        this.cityName=userProfile.getCityName();
        this.subCommunity=userProfile.getSubCommunity();
        this.maritalStatus=userProfile.getMaritalStatus();
        this.children=userProfile.getChildren();
        this.height=userProfile.getHeight();
        this.diet=userProfile.getDiet();
        this.qualifications=userProfile.getQualifications();
        this.college=userProfile.getCollege();
        this.income=userProfile.getIncome();
        this.worksWith=userProfile.getWorksWith();
        this.workAs=userProfile.getWorkAs();
        this.imageUrl=userProfile.getImageUrl();
        this.userId=userProfile.getUserId();
        this.images=userProfile.getImages();
        this.isProfileComplete=userProfile.isProfileComplete();
        this.accountType=userProfile.getAccountType();
        this.isVerified=userProfile.getIsVerified();
        this.time=userProfile.getTime();
        this.preferences=userProfile.getPreferences();
        this.latitude=userProfile.getLatitude();
        this.longitude=userProfile.getLongitude();
        this.aboutMe=userProfile.getAboutMe();
        this.date_of_birth=userProfile.getDate_of_birth();
