                    ...
                    if (task.isComplete() && task.isSuccessful()){
                       ...
                       //  insertSentConnection(connection);
                        ...
                        NotificationData notificationData= new NotificationData(currentUser.getImageUrl(), currentUser.getFullName(),
                                currentUser.getUserId(),currentUser.getFullName() + " is interested in your profile",otherUserMatches.getUserId(),String.valueOf(System.currentTimeMillis()),currentUser.getGender());
